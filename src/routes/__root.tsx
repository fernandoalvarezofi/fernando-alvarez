...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "WOREF — Preview your social posts across every platform" },
      ...
      { name: "author", content: "WOREF" },
      { property: "og:title", content: "WOREF — Preview your social posts across every platform" },
      ...
      { name: "twitter:title", content: "WOREF — Preview your social posts across every platform" },
